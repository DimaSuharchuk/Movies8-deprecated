...
class NodeMovie extends Node {
   ...
   * @param string $title
   *   Node title.
   * @param \Drupal\resource_saver\CollectionParagraphCast $field_cast
   *   List of persons who starred in the movie.
   * @param \Drupal\resource_saver\NodeCollection|null $field_collection
   *   Belongs to collection.
   * @param \Drupal\resource_saver\CollectionParagraphCrew $field_crew
   *   List of persons who worked on movie.
   * @param \Drupal\resource_saver\CollectionTaxonomyGenre $field_genres
   ...
   *   Movie overview.
   * @param \Drupal\resource_saver\MediaPoster $field_poster
   *   Poster Media entity.
   * @param \Drupal\resource_saver\CollectionMediaProductionCompany $field_production_companies
   *   Production companies created the movie.
   * @param \Drupal\resource_saver\CollectionNodeMovie $field_recommendations
   ...
   * @param \Drupal\resource_saver\CollectionNodeMovie $field_similar
   ...
   * @param \Drupal\resource_saver\CollectionMediaTrailer $field_trailers
